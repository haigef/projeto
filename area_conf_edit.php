<!--Recebe os campos para editar o cadastro da area -->
...
$query_area = "SELECT * FROM areas where Codigo_Areas = '".$_POST['Codigo_Areas']."'";
...
<title>Confirma&ccedil;&atilde;o de edi&ccedil;&atilde;o</title>
<link rel= "stylesheet" tipe= "text/css" href="css/default-2.css">
</head>
<body>
	<div class="corpo">
		<form class="form" name="edit" method="post" action="area_cadastros.php">
			<div class="grupo">
			...
			<div class="campos">
				...
				<input type="hidden" name="Codigo_Areas" value="<?php echo $_POST['Codigo_Areas'];?>" />
